package com.sygma.conversor;

import com.sygma.app.MensajeFinal;
import javax.swing.ImageIcon;
import javax.swing.JOptionPane;

public class Divisas {
    // Carga los íconos para mostrar en el cuadro de diálogo
    ImageIcon icon = new ImageIcon(getClass().getResource("/com/sygma/icons/icon-divisa.png"));
    ImageIcon iconM = new ImageIcon(getClass().getResource("/com/sygma/icons/icon-error.png"));
