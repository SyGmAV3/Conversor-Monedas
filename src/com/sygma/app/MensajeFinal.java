...
public class MensajeFinal {
    ...
    ImageIcon iconP = new ImageIcon(getClass().getResource("/com/sygma/icons/icon-question.png"));
    ImageIcon iconE = new ImageIcon(getClass().getResource("/com/sygma/icons/icon-salir.png"));
